...
DOMAIN2 = [
    dict(
        ...
        table_rows=[
            ("Expectation", "What the customer believes they'll get", "A 24-hour delivery promise"),
            ("Experience", "What actually happens", "The parcel arrives in 48 hours"),
            ("Gap", "The distance between the two", "A 24-hour shortfall in delivered service"),
            ("Perception", "The lasting belief that gap creates", "\"This brand overpromises\""),
        ],
        table_source="Source: Qualtrics, 2024",
    ...
    dict(
        ...
        table_rows=[
            ("Trigger", "The moment a customer decides to talk", "An unexpectedly great unboxing experience"),
            ("Channel", "Where they share it", "A review site, a group chat, a TikTok"),
            ("Amplification", "How far it travels from there", "A friend's friend sees the post"),
            ("Outcome", "The net effect on the brand", "New leads, or lost trust"),
        ],
    ...
    dict(
        ...
        table_rows=[
            ("Metric", "What is being tracked", "Engagement rate"),
            ("Source", "Where the data comes from", "Social platform analytics"),
    ...
    dict(
        ...
        table_source="Source: Active Listening in Customer Service, 2024",
